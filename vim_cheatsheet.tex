...
\embedfile[
    filespec = {\jobname.tex},
    mimetype = {application/x-latex},
    afrelationship = Source,
    desc = {The source code for this document, to be compiled using lualatex(1).},
]{\jobname.tex}
...
\babelfont{rm}[
    ...
    Scale = .8,
    Path = /home/e4071/meuk/SanDisk128GB/FONTS/Noto/,
    Extension = .ttf,
    UprightFont = *VF,
...
\babelfont{tt}[
    ...
    Numbers = {Uppercase, Tabular},
    Scale = MatchLowercase,
    Path = /home/e4071/meuk/SanDisk128GB/FONTS/Noto/,
    Extension = .ttf,
    UprightFont = *VF,
    BoldFont = *VF,
    RawFeature = {axis={wght=400,wdth=93.75}},
    BoldFeatures = {RawFeature = {axis={wght=700,wdth=93.75}}},
]{NotoSansMono}

% \babelfont{tt}[
%     Path = /home/e4071/meuk/SanDisk128GB/FONTS/monospaced fonts/Inconsolata/,
%     UprightFeatures = {RawFeature = {axis={wght=400,width=100}}},
%     Colour = solarizedbase01,
%     Numbers = {Lowercase, Proportional},
%     Scale = MatchLowercase,
%     % StylisticSet = 3,
...
\titleformat{\section}{\fontsize{14pt}{12pt}\fontseries{ub}\selectfont\color{accentcolor}}{}{0pt}{}
\titleformat{\subsection}{\fontsize{12pt}{12pt}\fontseries{b}\selectfont\itshape\color{accentcolor}}{}{0pt}{}
...
%     % \begin{textblock*}{0pt}(.333\paperwidth + .167\gutter - .5\mycolsep, 0pt)
%     \begin{textblock*}{0pt}(.333\paperwidth, 0pt)
%     \color{solarizedbase1}\rule{.2pt}{\paperheight}
%     \end{textblock*}
%     % \begin{textblock*}{0pt}(.667\paperwidth - .167\gutter + .5\mycolsep, 0pt)
%     \begin{textblock*}{0pt}(.667\paperwidth, 0pt)
%     \color{solarizedbase1}\rule{.2pt}{\paperheight}
%     \end{textblock*}
%     \normalcolor
% }
